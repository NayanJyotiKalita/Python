...
```
***Note:*** </br>
The list A and the integer B are already passed as an argument to the function. User don't need to take any input. </br>
Just perform the task on the passed arguments and return the required result. </br>
...
Explanation 2:
Ceil and floor of 9 will be 9 itself as 9 is present in the list.
```
